...
/obj/item/clothing/head/helmet/ironhelmos
	name = "Helmet"
	desc = "Heavy iron helmet. You don't expect anything from this, except protection."
	icon = 'modular_pod/icons/obj/clothing/hats.dmi'
...
/obj/item/clothing/suit/armor/powerarmor
	...
	dynamic_hair_suffix = ""
	flags_inv = HIDEHAIR|HIDEFACIALHAIR|HIDEMASK|HIDEEARS|HIDEEYES|HIDEFACE|HIDESNOUT|HIDEJUMPSUIT|HIDEOVERSUIT|HIDESUIT
	flags_cover = HEADCOVERSEYES | HEADCOVERSMOUTH | PEPPERPROOF
	slowdown = 2
	subarmor = list(SUBARMOR_FLAGS = NONE, \
				EDGE_PROTECTION = 90, \
