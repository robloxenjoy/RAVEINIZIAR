...
SUBSYSTEM_DEF(outdoor_effects)
	...
	var/list/datum/time_of_day/time_cycle_steps = list(new /datum/time_of_day/dawndawn(),
...
/datum/controller/subsystem/outdoor_effects/proc/get_time_of_day()
	...
	else if(istype(area, /area/maintenance/polovich/village))
		if(istype(current_step_datum, /datum/time_of_day/midnight))
	...
	else if(istype(area, /area/maintenance/polovich/forest/rain/village))
		if(istype(current_step_datum, /datum/time_of_day/midnight))
			area.droning_sound = DRONING_PURENIGHT_AKT
		else if(istype(current_step_datum, /datum/time_of_day/night))
			area.droning_sound = DRONING_PURENIGHT_AKT
...
/datum/controller/subsystem/outdoor_effects/proc/get_weather_overlay()
	...
	MA.icon 			  = 'modular_pod/code/modules/outdoor_effects/icons/effects/weather_overlay.dmi'
