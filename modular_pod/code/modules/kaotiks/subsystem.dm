...
/datum/controller/subsystem/bobux/proc/ShowChoices(client/noob)
	...
	var/datum/browser/popup = new(noob, "kaotik_window", "<div align='center'>kaotik</div>", 400, 800)
...
/datum/controller/subsystem/bobux/proc/GetDat(client/noob)
	...
	dat += "<center><b>Kaotik Menu</b></center><br>"
	dat += "<center>You currently have <b>[pref_source.bobux_amount]</b> kaotiks.</center><br>"
