...
//	for(var/mob/living/carbon/human/human in (GLOB.mob_living_list))
	...
	to_chat(world, "<span class='warning'><span class='big bold'>[emoji_parse(":fatal:")][our_fraggot.real_name] [our_fraggot.true_role] ФАТАЛ! УБЕЙТЕ ЭТУ СУЩЕСТВО![emoji_parse(":chaos:")]</span></span>")
