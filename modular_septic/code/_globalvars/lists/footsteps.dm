GLOBAL_LIST_INIT(footstep, list(
	FOOTSTEP_WOOD = list(list(
		...
		'modular_septic/sound/effects/footstep/wood4.wav',
		'modular_septic/sound/effects/footstep/wood5.wav'), 100, 2),
	...
	FOOTSTEP_METAL = list(list(
		'modular_septic/sound/effects/footstep/walk_metal1.wav',
		'modular_septic/sound/effects/footstep/walk_metal2.wav',
		'modular_septic/sound/effects/footstep/walk_metal3.wav',
		'modular_septic/sound/effects/footstep/walk_metal4.wav'), 100, 0),
	FOOTSTEP_STONE = list(list(
		'modular_septic/sound/effects/footstep/walk_tarmac1.wav',
		'modular_septic/sound/effects/footstep/walk_tarmac2.wav',
