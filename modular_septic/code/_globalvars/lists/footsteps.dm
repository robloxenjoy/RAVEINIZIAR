GLOBAL_LIST_INIT(footstep, list(
	...
	FOOTSTEP_FLOOR = list(list(
		...
		'modular_septic/sound/effects/footstep/floor3.wav',
		'modular_septic/sound/effects/footstep/floor4.wav'), 100, 0),
	FOOTSTEP_METAL = list(list(
		'modular_septic/sound/effects/footstep/walk_metal1.ogg',
		'modular_septic/sound/effects/footstep/walk_metal2.ogg',
		'modular_septic/sound/effects/footstep/walk_metal3.ogg',
		'modular_septic/sound/effects/footstep/walk_metal4.ogg'), 100, 0),
	FOOTSTEP_STONE = list(list(
		'modular_septic/sound/effects/footstep/walk_tarmac1.ogg',
		'modular_septic/sound/effects/footstep/walk_tarmac2.ogg',
		'modular_septic/sound/effects/footstep/walk_tarmac3.ogg',
		'modular_septic/sound/effects/footstep/walk_tarmac4.ogg'), 100, 0),
	...
	FOOTSTEP_GRASS = list(list(
		'modular_septic/sound/effects/footstep/grass1.ogg',
		'modular_septic/sound/effects/footstep/grass2.ogg',
		'modular_septic/sound/effects/footstep/grass3.ogg',
		'modular_septic/sound/effects/footstep/grass4.ogg'), 85, 0),
	...
	FOOTSTEP_CATWALK = list(list(
		'modular_septic/sound/effects/footstep/catwalk1.wav',
		'modular_septic/sound/effects/footstep/catwalk2.wav',
		'modular_septic/sound/effects/footstep/catwalk3.wav',
		'modular_septic/sound/effects/footstep/catwalk4.wav'), 65, 4),
	FOOTSTEP_HARDCATWALK = list(list(
		...
		'modular_septic/sound/effects/footstep/hardcatwalk4.wav'), 75, 4),
	FOOTSTEP_CRUMBLE = list(list(
		'modular_septic/sound/effects/footstep/crumble1.wav',
		'modular_septic/sound/effects/footstep/crumble2.wav',
		'modular_septic/sound/effects/footstep/crumble3.wav',
		'modular_septic/sound/effects/footstep/crumble4.wav'), 75, 4),
))
...
GLOBAL_LIST_INIT(barefootstep, list(
	...
	FOOTSTEP_GRASS = list(list(
		...
		'modular_septic/sound/effects/footstep/grass2.ogg',
		'modular_septic/sound/effects/footstep/grass3.ogg',
		'modular_septic/sound/effects/footstep/grass4.ogg'), 75, 0),
	FOOTSTEP_WATER = list(list(
		'modular_septic/sound/effects/footstep/water1.wav',
		'modular_septic/sound/effects/footstep/water2.wav',
		'modular_septic/sound/effects/footstep/water3.wav',
		'modular_septic/sound/effects/footstep/water4.wav'), 95, 1),
	FOOTSTEP_LAVA = list(list(
		'sound/effects/footstep/lava1.ogg',
		'sound/effects/footstep/lava2.ogg',
		'sound/effects/footstep/lava3.ogg'), 100, 0),
...
GLOBAL_LIST_INIT(heavyfootstep, list(
	...
	FOOTSTEP_WATER = list(list(
		...
		'modular_septic/sound/effects/footstep/water2.wav',
		'modular_septic/sound/effects/footstep/water3.wav',
		'modular_septic/sound/effects/footstep/water4.wav'), 100, 2),
	FOOTSTEP_LAVA = list(list(
		'sound/effects/footstep/lava1.ogg',
		'sound/effects/footstep/lava2.ogg',
		'sound/effects/footstep/lava3.ogg'), 100, 0),
