...
/datum/sprite_accessory/snouts/synthliz
	...
	icon = 'modular_septic/icons/mob/human/sprite_accessory/synthliz_snouts.dmi'
	color_src = USE_ONE_COLOR
	default_color = null
	recommended_species = list(SPECIES_SYNTHLIZARD)
...
/datum/sprite_accessory/tails/synthliz
	recommended_species = list("synthliz")
	icon = 'modular_septic/icons/mob/human/sprite_accessory/synthliz_tails.dmi'
	color_src = USE_ONE_COLOR
...
/datum/sprite_accessory/antenna/synthliz
	recommended_species = list("synthliz")
	icon = 'modular_septic/icons/mob/human/sprite_accessory/synthliz_antennas.dmi'
	color_src = USE_ONE_COLOR
