...
/datum/sprite_accessory/wings
	...
	recommended_species = list(SPECIES_HUMAN, SPECIES_SYNTHHUMAN, SPECIES_FELINE, SPECIES_LIZARD, SPECIES_SYNTHMAMMAL, SPECIES_MAMMAL, SPECIES_SYNTHLIZARD)
	relevant_layers = list(BODY_BEHIND_LAYER, BODY_FRONT_LAYER, BODY_ADJ_LAYER)
	body_zone = BODY_ZONE_CHEST
	genetic = TRUE
	organ_type = /obj/item/organ/external/wings

/datum/sprite_accessory/wings/is_hidden(mob/living/carbon/human/H, obj/item/bodypart/BP)
	. = ..()
	if(body_zone && !BP?.advanced_rendering)
		return TRUE
	if(H.wear_suit && (HAS_TRAIT(H, TRAIT_HIDING_MUTANTPARTS) || (H.wear_suit.flags_inv & HIDEJUMPSUIT)) && (!H.wear_suit.species_exception || !is_type_in_list(H.dna.species, H.wear_suit.species_exception)))
		return TRUE
...
/datum/sprite_accessory/wings/moth/get_preview_color()
	return COLOR_WHITE
...
/datum/sprite_accessory/wings/moth/dreamhead
	name = "Dreamhead"
	icon_state = "dreamhead"

/datum/sprite_accessory/wings/moth/delirious
	name = "Delirious"
