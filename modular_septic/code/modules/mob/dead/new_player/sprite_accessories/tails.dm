...
/datum/sprite_accessory/tails/is_hidden(mob/living/carbon/human/H, obj/item/bodypart/BP)
	. = ..()
	if(body_zone && !BP?.advanced_rendering)
		return TRUE
	if(H.wear_suit)
		if(HAS_TRAIT(H, TRAIT_HIDING_MUTANTPARTS))
			return TRUE
...
/datum/sprite_accessory/tails/get_special_render_colour(mob/living/carbon/human/H, passed_state)
	if(passed_state == "[general_type]_hardsuit") //Guarantees we're wearing a hardsuit, skip checks
		...
		if(HS.suit_tail_colors)
			...
			finished_list += ReadRGB("[sanitize_hexcolor(HS.suit_tail_colors[1], 6, FALSE)]00")
			finished_list += ReadRGB("[sanitize_hexcolor(HS.suit_tail_colors[2], 6, FALSE)]00")
			finished_list += ReadRGB("[sanitize_hexcolor(HS.suit_tail_colors[3], 6, FALSE)]00")
			finished_list += list(0,0,0,255)
			for(var/index in 1 to LAZYLEN(finished_list))
				finished_list[index] /= 255
			return finished_list
	return null

/datum/sprite_accessory/tails/lizard
	recommended_species = list(SPECIES_LIZARD, SPECIES_LIZARD_ASH, SPECIES_SYNTHMAMMAL, SPECIES_MAMMAL,  SPECIES_LIZARD_SILVER)
...
/datum/sprite_accessory/tails/monkey
	recommended_species = list(SPECIES_MONKEY)
	organ_type = /obj/item/organ/tail/monkey
	color_src = FALSE

/datum/sprite_accessory/tails/monkey/default
	name = "Monkey"
	icon_state = SPECIES_MONKEY
...
/datum/sprite_accessory/tails/mammal/wagging/werewolf
	recommended_species = list(SPECIES_SYNTHMAMMAL, SPECIES_MAMMAL, SPECIES_HUMAN, SPECIES_SYNTHHUMAN, SPECIES_WEREWOLF, SPECIES_HUMANOID)
	general_type = "vulpine"

/datum/sprite_accessory/tails/mammal/wagging/werecat
	recommended_species = list(SPECIES_SYNTHMAMMAL, SPECIES_MAMMAL, SPECIES_HUMAN, SPECIES_SYNTHHUMAN, SPECIES_WERECAT, SPECIES_HUMANOID)
	general_type = "feline"

/datum/sprite_accessory/tails/mammal/wagging/akula
	recommended_species = list(SPECIES_SYNTHMAMMAL, SPECIES_MAMMAL, SPECIES_HUMAN, SPECIES_SYNTHHUMAN, SPECIES_AQUATIC, SPECIES_HUMANOID)
	general_type = "marine"
...
/datum/sprite_accessory/tails/mammal/wagging/werecat/catbig
	name = "Cat, Big"
	icon_state = "catbig"
...
/datum/sprite_accessory/tails/mammal/wagging/werewolf/fox
	name = "Fox"
	icon_state = "fox"
	general_type = "vulpine"

/datum/sprite_accessory/tails/mammal/wagging/werewolf/fox2
	name = "Fox (Alt 2)"
	icon_state = "fox2"
	general_type = "vulpine"

/datum/sprite_accessory/tails/mammal/wagging/werewolf/fox3
	name = "Fox (Alt 3)"
	icon_state = "fox3"
	general_type = "vulpine"
