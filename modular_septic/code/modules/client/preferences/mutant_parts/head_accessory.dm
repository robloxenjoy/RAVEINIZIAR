...
/datum/preference/choiced/head_acc
	...
	main_feature_name = "Head accessory"
	relevant_mutant_bodypart = "head_acc"
	can_randomize = FALSE
	should_generate_icons = TRUE

/datum/preference/choiced/head_acc/create_informed_default_value(datum/preferences/preferences)
	. = ..()
...
/datum/preference/choiced/head_acc/compile_constant_data()
	var/list/data = ..()

	data[SUPPLEMENTAL_FEATURE_KEY] = "head_acc_color"

	return data

// Head accessory color
...
/datum/preference/tri_color/head_acc/create_informed_default_value(datum/preferences/preferences)
	var/part_type = preferences.read_preference(/datum/preference/choiced/head_acc)
	if(part_type)
