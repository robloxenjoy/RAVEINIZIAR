...
/datum/preference/tri_color/vagina/is_accessible(datum/preferences/preferences)
	...
	if(!(ORGAN_SLOT_VAGINA in GLOB.genital_sets[genitals_type]))
		return FALSE
...
/datum/preference/tri_color/vagina/create_informed_default_value(datum/preferences/preferences)
	...
	var/obj/item/organ/genital = datum_species.default_genitals[ORGAN_SLOT_VAGINA]
	qdel(datum_species)
