...
/datum/preference/choiced/moth_antennae/init_possible_values()
	return generate_possible_values_for_sprite_accessories_on_moth_head(GLOB.sprite_accessories[relevant_mutant_bodypart])
...
/datum/preference/choiced/moth_antennae/compile_constant_data()
	...
	data[SUPPLEMENTAL_FEATURE_KEY] = "moth_antennae_color"
...
/datum/preference/tri_color/moth_antennae/create_informed_default_value(datum/preferences/preferences)
	var/part_type = preferences.read_preference(/datum/preference/choiced/moth_antennae)
	if(part_type)
