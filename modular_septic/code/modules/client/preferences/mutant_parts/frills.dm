...
/datum/preference/choiced/frills/create_informed_default_value(datum/preferences/preferences)
	. = ..()
...
/datum/preference/tri_color/frills/create_informed_default_value(datum/preferences/preferences)
	var/part_type = preferences.read_preference(/datum/preference/choiced/frills)
	if(part_type)
