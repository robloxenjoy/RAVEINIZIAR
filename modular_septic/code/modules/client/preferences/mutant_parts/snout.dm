...
/datum/preference/choiced/snout/create_informed_default_value(datum/preferences/preferences)
	. = ..()
...
/datum/preference/tri_color/snout/create_informed_default_value(datum/preferences/preferences)
	var/part_type = preferences.read_preference(/datum/preference/choiced/snout)
	if(part_type)
