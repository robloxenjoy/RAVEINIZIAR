...
/datum/preferences/proc/load_preferences()
	...
	READ_FILE(S["septictoggles"], septictoggles)
...
/datum/preferences/proc/save_preferences()
	...
	WRITE_FILE(S["septictoggles"], septictoggles)
...
/datum/preferences/proc/load_character(slot)
	...
	READ_FILE(S["genitals"], genitals)
	READ_FILE(S["body_type"], body_type)
	READ_FILE(S["age"], age)
	READ_FILE(S["hair_color"], hair_color)
	READ_FILE(S["facial_hair_color"], facial_hair_color)
	READ_FILE(S["left_eye_color"], left_eye_color)
	READ_FILE(S["right_eye_color"], right_eye_color)
	...
	genitals = sanitize_inlist(genitals, GLOB.genital_sets, (gender == FEMALE ? "Female" : "Male"))
	...
	underwear_color = sanitize_hexcolor(underwear_color, 6, FALSE)
	...
	undershirt_color = sanitize_hexcolor(undershirt_color, 6, FALSE)

	READ_FILE(S["socks_color"], socks_color)
	socks_color	= sanitize_hexcolor(socks_color, 6, FALSE)
	...
	READ_FILE(S["pref_birthsign"], pref_birthsign)
	...
	READ_FILE(S["handedness"], handedness)
	handedness = sanitize_integer(handedness)
	READ_FILE(S["blood_type"], blood_type)
	blood_type = sanitize_inlist(blood_type, get_safe_blood("AB+") | "Random", "Random")

	if(!pref_birthsign || !GLOB.culture_birthsigns[pref_birthsign])
...
/datum/preferences/proc/save_character()
	...
	WRITE_FILE(S["genitals"], genitals)
	...
	WRITE_FILE(S["pref_birthsign"] , pref_birthsign)

	WRITE_FILE(S["languages"], languages)
	WRITE_FILE(S["handedness"], handedness)
