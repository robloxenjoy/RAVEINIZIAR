...
h1, h2, h3, h4, h5, h6	{color: #0000ff;	font-family: Verdana;}

em						{font-style: normal;	font-weight: bold;}

.motd					{color: #638500;	font-family: Verdana;}
...
.alert					{color: #ff0000; text-shadow: 0 0 1px #e72525;}
h1.alert, h2.alert		{color: #000000;}

.emote					{}
.infoplain				{}

.userlove				{color: #ff57cd; text-shadow: 0 0 6px #e72b8f; font-style: italic; font-size: 110%;}

.love					{color: #ff45c7; font-style: italic; text-shadow: 0 0 6px #cc77ee;}

.horny					{color: #ff4591; font-style: italic; text-shadow: 0 0 3px #9b4e77;}
...
.boldwarning			{color: #ff0000; text-shadow: 0 0 3px #ff4747; font-style: italic; font-weight: bold}
.announce				{color: #228b22;	font-weight: bold;}
.boldannounce			{color: #ff0000;	font-weight: bold;}
.minorannounce			{					font-weight: bold;  font-size: 3;}
.greenannounce			{color: #00ff00;	font-weight: bold;}
.rose					{color: #ff5050;}
.info					{color: #0000CC; text-shadow: 0 0 3px #3e3eb1;}
.notice					{color: #000099; text-shadow: 0 0 3px #262697;}
.tinynotice				{color: #000099; text-shadow: 0 0 3px #262697; font-size: 85%;}
...
.infobox				{border: 1px ridge #383243; background: rgba(40, 40, 60, 0.5); margin: 2px 8px; padding: 8px 12px; max-width: 550px;}

.infohr 				{border: 0; height: 1px; background-image: linear-gradient(to right, rgba(187, 187, 255, 0), rgba(187, 187, 255, 0.65), rgba(187, 187, 255, 0));}
