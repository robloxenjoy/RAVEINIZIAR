...
/datum/mood_event/cold
	description = "<span class='warning'>Здесь слишком холодно.</span>\n"
	mood_change = -5

/datum/mood_event/hot
	description = "<span class='warning'>Здесь слишком горячо.</span>\n"
	mood_change = -5
...
/datum/mood_event/slipped
	description = "<span class='warning'>Я подскользнулся...</span>\n"
	mood_change = -2
	timeout = 3 MINUTES
...
/datum/mood_event/brain_damage/add_effects()
	...
	description = "<span class='warning'>Брраа ббээ... [damage_message]</span>\n"
...
/datum/mood_event/jittery
	description = "<span class='warning'>I'm nervous!</span>\n"
	mood_change = -2

/datum/mood_event/vomit
	description = "<span class='warning'>I vomited.</span>\n"
	mood_change = -2
	timeout = 2 MINUTES

/datum/mood_event/vomitself
	description = "<span class='warning'>I puked on myself.</span>\n"
	mood_change = -4
	timeout = 3 MINUTES
