...
/datum/crafting_recipe/shitbarricade
	name = "Shit Barricade"
	result = /obj/structure/barricade/shit
	time = 30
	reqs = list(/obj/item/shit = 3)
	category = CAT_STRUCTURE

/datum/crafting_recipe/bonefloor
	name = "Tiled Bone Floor"
	result = /turf/open/floor/plating/polovich/bonefloor
	time = 30
	reqs = list(/obj/item/organ/bone = 4)
	category = CAT_FLOORSWALLS
