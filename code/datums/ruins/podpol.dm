/datum/map_template/ruin/podpol
...
/datum/map_template/ruin/podpol/ruinea
	name = "Руины"
	id = "podpol-ruinea"
	...
	placement_weight = 1
	suffix = "room1.dmm"
	description = "Осколки породы."

/datum/map_template/ruin/podpol/room2
	name = "Странная Комната"
	id = "podpol-room"
	allow_duplicates = TRUE
	cost = 0
	placement_weight = 1
	suffix = "room2.dmm"
	description = "Что же было здесь сука раньше?"

/datum/map_template/ruin/podpol/shroom
