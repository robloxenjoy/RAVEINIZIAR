...
/datum/brain_trauma/severe/aphasia/on_gain()
	owner.add_blocked_language(subtypesof(/datum/language/) - /datum/language/monkey, LANGUAGE_APHASIA)
	owner.grant_language(/datum/language/monkey, TRUE, TRUE, LANGUAGE_APHASIA)
	..()

/datum/brain_trauma/severe/aphasia/on_lose()
	owner.remove_blocked_language(subtypesof(/datum/language/), LANGUAGE_APHASIA)
	owner.remove_language(/datum/language/monkey, TRUE, TRUE, LANGUAGE_APHASIA)
	..()
...
/datum/brain_trauma/severe/blindness
	...
	gain_text = "<span class='warning'>Я не могу видеть!</span>"
	lose_text = "<span class='notice'>Моё зрение возвращается.</span>"
...
/datum/brain_trauma/severe/halitus_deprivation
	...
	gain_text = span_warning("I have problems with breathing...")
	lose_text = span_notice("Now I can breathe.")
