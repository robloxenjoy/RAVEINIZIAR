//Delta needed for the splash effect to be made in 1 go
#define WATER_HEIGHT_DIFFERENCE_SPLASH 7
//Chance to play if the delta is satisfied
#define WATER_HEIGHT_DIFFERENCE_SOUND_CHANCE 50

#define REQUIRED_EVAPORATION_PROCESSES 60
#define EVAPORATION_CHANCE 65
...
#define LIQUID_GIVER (1<<0)
#define LIQUID_TAKER (1<<1)
...
#define TURF_HEIGHT_BLOCK_THRESHOLD_TEST 50
...
//Add this to the liquid state if lying down
...
#define LIQUID_WAIST_LEVEL_HEIGHT 20
#define LIQUID_SHOULDERS_LEVEL_HEIGHT 30
#define LIQUID_FULLTILE_LEVEL_HEIGHT 40
...
#define OXYGEN_DAMAGE_CHOKING_THRESHOLD 20
...
#define LIQUIDS_GROUP_DECAY_TIME 3
...
#define TOTAL_LIQUID_HEIGHT(turf) (turf.liquid_height + turf.liquids?.liquid_height)
