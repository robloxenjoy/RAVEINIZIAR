...
#define DEPARTMENT_UNASSIGNED "НЕИЗВЕСТНО"
#define DEPARTMENT_BITFLAG_SECURITY (1<<0)
#define DEPARTMENT_SECURITY "НЕИЗВЕСТНО"
#define DEPARTMENT_BITFLAG_COMMAND (1<<1)
#define DEPARTMENT_COMMAND "НЕИЗВЕСТНО"
#define DEPARTMENT_BITFLAG_SERVICE (1<<2)
#define DEPARTMENT_SERVICE "НЕИЗВЕСТНО"
#define DEPARTMENT_BITFLAG_CARGO (1<<3)
#define DEPARTMENT_CARGO "Арена"
#define DEPARTMENT_BITFLAG_ENGINEERING (1<<4)
#define DEPARTMENT_ENGINEERING "НЕИЗВЕСТНО"
#define DEPARTMENT_BITFLAG_SCIENCE (1<<5)
#define DEPARTMENT_SCIENCE "НЕИЗВЕСТНО"
#define DEPARTMENT_BITFLAG_MEDICAL (1<<6)
#define DEPARTMENT_MEDICAL "НЕИЗВЕСТНО"
#define DEPARTMENT_BITFLAG_SILICON (1<<8)
#define DEPARTMENT_SILICON "НЕИЗВЕСТНО"
