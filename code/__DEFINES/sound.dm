//max channel is 1026. Only go lower from here, because byond tends to pick the first available channel to play sounds on
#define CHANNEL_LOBBYMUSIC 1026
#define CHANNEL_ADMIN 1025
#define CHANNEL_VOX 1024
#define CHANNEL_JUKEBOX 1023
#define CHANNEL_HEARTBEAT 1022 //sound channel for heartbeats
