...
#define SOUND_MUSIC_COMBAT (1<<4)
#define SOUND_MUSIC_AMBIENCE (1<<5)
#define SOUND_LOBBY (1<<6)
#define MEMBER_PUBLIC (1<<7)
#define SOUND_INSTRUMENTS (1<<8)
...
#define TOGGLES_DEFAULT (SOUND_ADMINHELP|SOUND_MIDI|SOUND_AMBIENCE|SOUND_SHIP_AMBIENCE|SOUND_MUSIC_COMBAT|SOUND_MUSIC_AMBIENCE|SOUND_LOBBY|SOUND_ENDOFROUND|MEMBER_PUBLIC|SOUND_INSTRUMENTS|SOUND_SHIP_AMBIENCE|SOUND_PRAYERS|SOUND_ANNOUNCEMENTS|SOUND_COMBATMODE)
