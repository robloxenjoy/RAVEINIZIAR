...
#define SOUND_SHIP_AMBIENCE (1<<3)
#define SOUND_MUSIC_AMBIENCE (1<<4)
#define SOUND_LOBBY (1<<5)
#define MEMBER_PUBLIC (1<<6)
#define SOUND_INSTRUMENTS (1<<7)
#define SOUND_PRAYERS (1<<8)
#define ANNOUNCE_LOGIN (1<<9)
#define SOUND_ANNOUNCEMENTS (1<<10)
#define DISABLE_DEATHRATTLE (1<<11)
#define DISABLE_ARRIVALRATTLE (1<<12)
#define COMBOHUD_LIGHTING (1<<13)
#define DEADMIN_ALWAYS (1<<14)
#define DEADMIN_ANTAGONIST (1<<15)
#define DEADMIN_POSITION_HEAD (1<<16)
#define DEADMIN_POSITION_SECURITY (1<<17)
#define DEADMIN_POSITION_SILICON (1<<18)
#define SOUND_ENDOFROUND (1<<19)
#define ADMIN_IGNORE_CULT_GHOST (1<<20)
#define SOUND_COMBATMODE (1<<21)
#define SPLIT_ADMIN_TABS (1<<22)

#define TOGGLES_DEFAULT (SOUND_ADMINHELP|SOUND_MIDI|SOUND_AMBIENCE|SOUND_SHIP_AMBIENCE|SOUND_MUSIC_AMBIENCE|SOUND_LOBBY|SOUND_ENDOFROUND|MEMBER_PUBLIC|SOUND_INSTRUMENTS|SOUND_SHIP_AMBIENCE|SOUND_PRAYERS|SOUND_ANNOUNCEMENTS|SOUND_COMBATMODE)
