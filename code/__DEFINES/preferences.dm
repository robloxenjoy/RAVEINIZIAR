...
#define SOUND_LOBBY (1<<4)
#define MEMBER_PUBLIC (1<<5)
#define SOUND_INSTRUMENTS (1<<6)
#define SOUND_PRAYERS (1<<7)
#define ANNOUNCE_LOGIN (1<<8)
#define SOUND_ANNOUNCEMENTS (1<<9)
#define DISABLE_DEATHRATTLE (1<<10)
#define DISABLE_ARRIVALRATTLE (1<<11)
#define COMBOHUD_LIGHTING (1<<12)
#define DEADMIN_ALWAYS (1<<13)
#define DEADMIN_ANTAGONIST (1<<14)
#define DEADMIN_POSITION_HEAD (1<<15)
#define DEADMIN_POSITION_SECURITY (1<<16)
#define DEADMIN_POSITION_SILICON (1<<17)
#define SOUND_ENDOFROUND (1<<18)
#define ADMIN_IGNORE_CULT_GHOST (1<<19)
#define SOUND_COMBATMODE (1<<20)
