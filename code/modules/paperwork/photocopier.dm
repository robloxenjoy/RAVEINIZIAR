...
/obj/machinery/photocopier/MouseDropReceive(mob/target, mob/user)
...
/**
 * Checks if the copier is deleted, or has something dense at its location. Called in `MouseDropReceive()`
 */
