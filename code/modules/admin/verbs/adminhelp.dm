...
/client/verb/adminhelp(msg as message)
	...
	if(current_ticket)
		...
		return
	//SEPTIC EDIT BEGIN
	to_chat(world, "<span class='ooc'><font color='[GLOB.OOC_COLOR]'><span class='prefix'>OOC:</span> <EM>[key]:</EM> <span class='message linkify'>Я ХОЧУ ЧТОБЫ МЕНЯ <span class='flashingdanger'>ЗАХУЯЧИЛИ</span>!</font></span>")
	//SEPTIC EDIT END
	/* SEPTIC EDIT REMOVAL
