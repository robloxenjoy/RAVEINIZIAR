...
/datum/admins/proc/show_player_panel(mob/M in GLOB.mob_list)
	...
	body += "<A href='?_src_=holder;[HrefToken()];rank=[REF(M)]'>Rank</A> | "
	body += "<A href='?_src_=holder;[HrefToken()];fatal=[REF(M)]'>Make fatal</A> | "
	body += "<A href='?_src_=holder;[HrefToken()];fatalremove=[REF(M)]'>Remove fatal</A> | "
	body += "<A href='?_src_=holder;[HrefToken()];takegame=[REF(M)]'>Remove him from game</A> | "
