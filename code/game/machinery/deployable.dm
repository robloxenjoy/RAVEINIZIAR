...
/obj/structure/barricade/shit
	name = "Shit Barricade"
	desc = "Looking at this, you feel safe."
	icon = 'modular_septic/icons/obj/structures/structures.dmi'
	icon_state = "shitbar"
	base_icon_state = "shitbar"
	max_integrity = 70
	proj_pass_rate = 20
	pass_flags_self = LETPASSTHROW
	bar_material = SAND

/obj/structure/barricade/shit/make_debris()
	new /obj/item/shit(get_turf(src), 3)

/obj/structure/barricade/shit/Initialize(mapload)
	. = ..()
	AddElement(/datum/element/climbable)

/obj/structure/barricade/shit/north
	dir = NORTH

/obj/structure/barricade/shit/south
	dir = SOUTH

/obj/structure/barricade/shit/east
	dir = EAST

/obj/structure/barricade/shit/west
	dir = WEST
