...
//	bite_consumption_mod = 2
	...
	food_reagents = list(.datum/reagent/consumable/bluecherryjelly = 1, /datum/reagent/medicine/c2/penthrite = 1)
	w_class = WEIGHT_CLASS_TINY
	eat_time = 2
//	bitecount = 1
	bite_consumption = 2
...
/obj/item/food/berries/redcherrie
	name = "Gule Berry"
	desc = "Berry."
	icon = 'icons/obj/food/food.dmi'
...
/obj/item/food/berries/redcherrie/lie/examine(mob/user)
	. = ..()
