...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		//SEPTIC EDIT BEGIN
		"TRAIT_CAPITALIST_MOOD" = TRAIT_CAPITALIST_MOOD,
		"TRAIT_NOPAIN" = TRAIT_NOPAIN,
		"TRAIT_PAINLOVER" = TRAIT_PAINLOVER,
		"TRAIT_TRYINGTOSLEEP" = TRAIT_TRYINGTOSLEEP,
		"TRAIT_BLOODLOSSIMMUNE" = TRAIT_BLOODLOSSIMMUNE,
		"TRAIT_SPRINT_LOCKED" = TRAIT_SPRINT_LOCKED,
		"TRAIT_NOHUSK" = TRAIT_NOHUSK,
		"TRAIT_HIDING_MUTANTPARTS" = TRAIT_HIDING_MUTANTPARTS,
		"TRAIT_TYPING_INDICATOR" = TRAIT_TYPING_INDICATOR,
		"TRAIT_SSD_INDICATOR" = TRAIT_SSD_INDICATOR,
		"TRAIT_FRAGGOT" = TRAIT_FRAGGOT,
		"TRAIT_MISANTHROPE" = TRAIT_MISANTHROPE,
		"TRAIT_STUMBLE" = TRAIT_STUMBLE,
		"TRAIT_HOLDING_BREATH" = TRAIT_HOLDING_BREATH,
		"TRAIT_WATER_BREATHING" = TRAIT_WATER_BREATHING,
		"TRAIT_NOPARRY" = TRAIT_NOPARRY,
		"TRAIT_FLUORIDE_STARE" = TRAIT_FLUORIDE_STARE,
		"TRAIT_HORROR_STARE" = TRAIT_HORROR_STARE,
		"TRAIT_NO_ROTTEN_AFTERLIFE" = TRAIT_NO_ROTTEN_AFTERLIFE,
		"TRAIT_SOFT_CRITICAL_CONDITION" = TRAIT_SOFT_CRITICAL_CONDITION,
		"TRAIT_METALLIC_TASTES" = TRAIT_METALLIC_TASTES,
		"TRAIT_IMMUNITY_CRIPPLED" = TRAIT_IMMUNITY_CRIPPLED,
		"TRAIT_ILLITERATE" = TRAIT_ILLITERATE,
		"TRAIT_CANTBREATH" = TRAIT_CANTBREATH,
		"TRAIT_LOOKING_INTO_DISTANCE" = TRAIT_LOOKING_INTO_DISTANCE,
		"TRAIT_BITTEN" = TRAIT_BITTEN,
		//SEPTIC EDIT END
		...
		"TRAIT_HYPERSENT" = TRAIT_HYPERSENT,
	...
	/obj/item/bodypart = list(
		//SEPTIC EDIT BEGIN
		"TRAIT_ROTTEN" = TRAIT_ROTTEN,
		"TRAIT_DEFORMED" = TRAIT_DEFORMED,
		"TRAIT_NOPAIN" = TRAIT_NOPAIN,
		"TRAIT_NEVER_WOUNDED" = TRAIT_NEVER_WOUNDED,
		"TRAIT_EASILY_WOUNDED" = TRAIT_EASILY_WOUNDED,
		"TRAIT_HARDLY_WOUNDED" = TRAIT_HARDLY_WOUNDED,
	...
	/obj/item = list(
		//SEPTIC EDIT BEGIN
		"TRAIT_WEAPON_UNREADY" = TRAIT_WEAPON_UNREADY,
		//SEPTIC EDIT END
	...
	/atom/movable = list(
		...
		"TRAIT_RAIN_IMMUNE" = TRAIT_RAIN_IMMUNE,
