SUBSYSTEM_DEF(job)
	...
	var/overflow_role = /datum/job/zek_glad
...
/datum/controller/subsystem/job/proc/FindOccupationCandidates(datum/job/job, level, flag)
	...
	for(var/mob/dead/new_player/player in unassigned)
		...
		if(job.has_banned_quirks(player.client.prefs))
			...
			continue
		if(job.is_banned_species(player.client.prefs))
...
//			to_chat(human, "<span class='warning'><span class='big bold'>[emoji_parse(":fatal:")][name_override ? name_override : real_name] IS A FRAGGOT! KILL THIS CREATURE![emoji_parse(":chaos:")]</span></span>")
/*
...
/datum/controller/subsystem/job/proc/setup_job_lists()
	station_jobs = list("Assistant", "Akt Controller", "Captain", "Head of Personnel", "Bartender", "Cook", "Botanist", "Quartermaster", "Cargo Technician", \
		...
		"Research Director", "Scientist", "Roboticist", "Head of Security", "Warden", "Venturer", "Detective", "Security Officer", "Prisoner")
