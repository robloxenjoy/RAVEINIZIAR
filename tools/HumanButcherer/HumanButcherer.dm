...
/client/verb/butcher_humans()
	...
	for(var/icon_state in icon_states)
		...
		usr << "gendered icon: [icon_state]"
		usr << "ungendered icon: [genderless_state]"
		...
		if(!current_body_zone)
			usr << "Unable to find associated body zone for [icon_state]"
		else
			...
			usr << "unparsed body zone: [unparsed_body_zone]"
		...
		usr << "zoneless state: [zoneless_state]"
